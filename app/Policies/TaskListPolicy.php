...
class TaskListPolicy
{
    ...
    {
        return $user->can('force_delete_task::list');
    }
    ...
    {
        return $user->can('force_delete_any_task::list');
    }
    ...
    {
        return $user->can('restore_task::list');
    }
    ...
    {
        return $user->can('restore_any_task::list');
    }
    ...
    {
        return $user->can('replicate_task::list');
    }
    ...
    {
        return $user->can('reorder_task::list');
    }
}
